...
<span class="s0">public class </span><span class="s1">BubbleSort { 
        ...
        System.out.println()</span><span class="s0">;</span><span class="s1"> 
        ...
        </span><span class="s0">boolean </span><span class="s1">isFinished = </span><span class="s0">false;</span><span class="s1"> 
            ...
            isFinished = iterate()</span><span class="s0">;</span><span class="s1"> 
            System.out.println()</span><span class="s0">;</span><span class="s1"> 
        } 
        ...
        printList()</span><span class="s0">;</span><span class="s1"> 
    ...
    </span><span class="s0">public static boolean </span><span class="s1">iterate() { 
        </span><span class="s0">int </span><span class="s1">counter = </span><span class="s3">0</span><span class="s0">;</span><span class="s1"> 
        </span><span class="s0">for </span><span class="s1">(</span><span class="s0">int </span><span class="s1">i = </span><span class="s3">0</span><span class="s0">; </span><span class="s1">i &lt; length - </span><span class="s3">1</span><span class="s0">; </span><span class="s1">i++) { 
                ...
                temp = input[i]</span><span class="s0">;</span><span class="s1"> 
                input[i] = input[i + </span><span class="s3">1</span><span class="s1">]</span><span class="s0">;</span><span class="s1"> 
                input[i + </span><span class="s3">1</span><span class="s1">] = temp</span><span class="s0">;</span><span class="s1"> 
            } 
            printList()</span><span class="s0">;</span><span class="s1"> 
        } 
