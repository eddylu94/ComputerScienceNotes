<head>
<title>ImplementList.java</title>
...
<span class="s0">public class </span><span class="s1">ImplementList { 
        ...
        list.removeNode(</span><span class="s3">3</span><span class="s1">)</span><span class="s0">;</span><span class="s1"> 
        list.appendToTail(</span><span class="s3">6</span><span class="s1">)</span><span class="s0">;</span><span class="s1"> 
        list.removeNode(</span><span class="s3">4</span><span class="s1">)</span><span class="s0">;</span><span class="s1"> 
        list.appendToTail(</span><span class="s3">7</span><span class="s1">)</span><span class="s0">;</span><span class="s1"> 
        list.appendToTail(</span><span class="s3">8</span><span class="s1">)</span><span class="s0">;</span><span class="s1"> 
        list.appendToTail(</span><span class="s3">6</span><span class="s1">)</span><span class="s0">;</span><span class="s1"> 
